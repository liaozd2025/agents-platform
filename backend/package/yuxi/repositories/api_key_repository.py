...
class APIKeyRepository:
    ...
    async def list_visible(
        ...
        *,
        ...
        skip: int,
        limit: int,
        visible_user_ids: Collection[int] | None = None,
        ...
        if visible_user_ids is not None:
            query = query.where(APIKey.user_id.in_(visible_user_ids))
            count_query = count_query.where(APIKey.user_id.in_(visible_user_ids))
