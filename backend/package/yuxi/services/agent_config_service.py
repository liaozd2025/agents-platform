...
from yuxi.agents.context import BaseContext, filter_agent_config_for_management, resolve_agent_resource_options
...
async def prepare_agent_config_write(
    ...
    *,
    ...
    filtered = filter_agent_config_for_management(
        config_json, build_authorization_context(user).has_permission("agent:manage"), context_schema
    )
