...
const benchmarkDetailRouteName = computed(() =>
  route.matched.some((record) => record.meta.embed === true)
    ? 'EmbedExtensionEvaluationBenchmarkDetail'
    : 'ExtensionEvaluationBenchmarkDetail'
)
...
const openDataset = (dataset) => {
  ...
  router.push({
    name: benchmarkDetailRouteName.value,
