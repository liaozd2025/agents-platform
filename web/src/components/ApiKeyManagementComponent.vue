              ...
              <template #bodyCell="{ column, record }">
                ...
                <template v-if="column.key === 'owner'">
                  <span class="time-text">
                    {{ record.user_id === userStore.userId ? '当前用户' : record.user_id }}
                  </span>
                </template>
...
const columns = [
  ...
  { title: '归属用户', dataIndex: 'user_id', key: 'owner', width: '18%' },
  { title: '前缀', dataIndex: 'key_prefix', key: 'prefix', width: '14%' },
  { title: '状态', dataIndex: 'is_enabled', key: 'status', width: '12%' },
  { title: '最后使用', dataIndex: 'last_used_at', key: 'lastUsed', width: '16%' },
  { title: '过期时间', dataIndex: 'expires_at', key: 'expiresAt', width: '14%' },
  { title: '操作', key: 'action', width: '8%', align: 'center' }
]
